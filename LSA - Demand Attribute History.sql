	...
	from
		...
		left join 
		    ...
		    where
				...
				and EDWARD.CONSUMER_GRP.CONSM_GRP_ID in ('MEN','001')
				and EDWARD.PRODUCT.PROD_CAT_CD like '%Bottom%'
				and tmp_MAX_CHANGE_DATE.FISC_YR_KEY in (2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017)) tmp_PC9_MONTHLY_DA on
...
) with data primary index (PC9, FISC_MTH_KEY) on commit preserve rows;
